...
//        DataStreamSource<BusinessProflile> b = env.addSource(new BusinessSourceNew());
//
//        b.map(line->line).print();
//
//        env.execute();
...
//        2.读取数据
//        DataSource<String> dataSource = envE.readTextFile("D:\\output\\project.txt");
